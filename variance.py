...
print("Variance for points is",variance_points/len(points))
variance_score = 0
for i in score:
      variance_score = ((( i - mean_score)*( i - mean_score))+ variance_score)
print("Variance for scores is",variance_score/len(score))
variance_weight = 0
for i in weights:
    variance_weight = ((( i - mean_weights)*( i - mean_weights))+variance_weight)
print("Variance for Weights is",variance_weight/len(weights))
